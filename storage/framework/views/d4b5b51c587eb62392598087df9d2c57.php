            ...
            <table class="table mb-0" style="width: 100%;border-collapse: collapse;table-layout: fixed;white-space: nowrap; height: auto;">
                <thead>
                    <tr>
                        ...
                        <th ><?php echo e(trans('all.Description')); ?></th>
                    ...
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($service != null): ?>
                            <tr>
                                ...
                                <td style="width: 25%"><?php echo e($service->title); ?></td>
                                <td style="width: 25%"><?php if($service->image): ?><img style="width: 100%" src="<?php echo e(asset($service->image)); ?>"><?php else: ?> -  <?php endif; ?></td>
                                <td style="overflow: hidden; text-overflow: ellipsis"><?php echo e($service->description); ?></td>

                                <td style="width: 10%;"><?php echo e($service->order); ?></td>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mariam\iwan\resources\views/backend/services/index.blade.php ENDPATH**/ ?>