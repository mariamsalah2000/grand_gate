                    ...
                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($project != null): ?>
                            <tr>
                                ...
                                <td><img src="<?php echo e(asset($project->images->first()->url)); ?>"></td>
                                <?php else: ?>
                                <td><?php echo e(trans('all.no_image')); ?></td>
                                <?php endif; ?>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iwan\resources\views/backend/projects/index.blade.php ENDPATH**/ ?>