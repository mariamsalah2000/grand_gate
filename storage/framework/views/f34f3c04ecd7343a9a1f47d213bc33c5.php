...
<div class=" text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3"><?php echo e(trans('all.All Benefits')); ?></h1>
    </div>
</div>
...
<div class="card">
    <form class="" id="sort_customers" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-0 h6"><?php echo e(trans('all.Benefits')); ?></h5>
            </div>
            ...
            <table class="table mb-3">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(trans('all.Icon')); ?></th>
                    ...
                    <?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($benefit): ?>
                            <tr>
                                ...
                                <td ><i class="<?php echo e($benefit->icon); ?>" style="font-size:25px"></i></td>
                                <td class="text-right">
                                    <a href="<?php echo e(route('benefits.edit', $benefit->id)); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="<?php echo e(trans('all.Edit')); ?>">
                                            <i class="las la-edit"></i>
                                    </a>
                                    <a href="<?php echo e(route('benefits.destroy', $benefit->id)); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="<?php echo e(trans('all.Delete')); ?>">
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mariam\iwan\resources\views/backend/benefits/index.blade.php ENDPATH**/ ?>