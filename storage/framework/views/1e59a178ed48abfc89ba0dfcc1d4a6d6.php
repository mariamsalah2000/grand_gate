...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3"><?php echo e(trans('all.All Videos')); ?></h1>
    </div>
</div>
...
<div class="card">
    <form class="" id="sort_customers" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-0 h6"><?php echo e(trans('all.Videos')); ?></h5>
            </div>
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg"><?php echo e(trans('all.url')); ?></th>
                    ...
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($video != null): ?>
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="<?php echo e(route('videos')); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="<?php echo e(trans('all.View')); ?>">
                                            <i class="las la-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('videos.edit', $video->id)); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="<?php echo e(trans('all.Edit')); ?>">
                                            <i class="las la-edit"></i>
                                    </a>
                                    <a href="<?php echo e(route('videos.destroy', $video->id)); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="<?php echo e(trans('all.Delete')); ?>">
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iwan\resources\views/backend/videos/index.blade.php ENDPATH**/ ?>