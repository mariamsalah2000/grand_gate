            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('all.add_project')); ?></h4>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('projects.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3 lg-gutters-25 text-center">
                                ...
                                <select name="category_id" class="form-control" placeholder="<?php echo e(trans('all.select_category')); ?>" required>
                                    <option value=""><?php echo e(trans('choose_category')); ?></option>
                            ...
                            <div class="form-group mb-3 lg-gutters-25 text-center">
                                <label for="images"><strong><?php echo e(trans('all.images')); ?></strong></label>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iwan\resources\views/backend/projects/create.blade.php ENDPATH**/ ?>