...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3"><?php echo e(trans('all.All requests')); ?></h1>
    </div>
</div>
...
<div class="card">
    <form class="" id="sort_customers" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-0 h6"><?php echo e(trans('all.requests')); ?></h5>
            </div>
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(trans('all.phone')); ?></th>
                        <th data-breakpoints="lg"><?php echo e(trans('all.inquiry')); ?></th>
                    ...
                    <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($request != null): ?>
                            <tr>
                                ...
                                <td><?php echo e($request->inquiry); ?></td>

                                <td class="text-right">
                                    <a href="<?php echo e(route('contact_request',$request->id)); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="<?php echo e(trans('all.View')); ?>">
                                            <i class="las la-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('requests.destroy', $request->id)); ?>" class="btn btn-soft-success btn-icon btn-circle btn-sm" title="<?php echo e(trans('all.Delete')); ?>">
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iwan\resources\views/backend/contact/index.blade.php ENDPATH**/ ?>